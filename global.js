...
exports.OTP_MESSAGE = "We have sent and OTP to your mobile number. Please type OTP and Token from app using: \n@otp <otp number> <token> \n(eg. @otp 32435 34314)";
exports.OTP_INVALID_MESSAGE = "You have entered invalid OPT. Please try again with the same command.";
exports.TOKEN_INVALID_MESSAGE = "You have entered invalid Token. Please try again with the same command.";
